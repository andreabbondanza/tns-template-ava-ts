    ...
    */
    public toStandardResponse<U>(): StandardResponse<U>
    {
        ...
        if (this.response.hasOwnProperty("body"))
            ...
            json = (this.response as any).content.toJSON();
...
export class RestClient
{
     ...
     */
    public async POSTMP(url: string, data: object | null, headers?: object | null): Promise<RestResponse<TNSHttpFormDataResponse>>
    {
        ...
        {
            throw new HttpErrorM(new RestResponse<TNSHttpFormDataResponse>(resp));
        }
    }
    /**
     ...
     * @throws HttpError
     */
    public async POST(url: string, data: object | null, headers?: object | null): Promise<RestResponse<HttpResponse>>
    {
        if (headers === null)
        {
            headers = this.DefaultHeaders;
        ...
        if (resp.statusCode >= 200 && resp.statusCode < 300)
            ...
            throw new HttpError(new RestResponse<HttpResponse>(resp));
    }
    /**
     * Execute a POST httprequest
     * @param options options
     * @throws HttpError
     */
    public async PUT(url: string, data: object | null, headers?: object | null): Promise<RestResponse<HttpResponse>>
    {
        if (headers === null)
        {
            headers = this.DefaultHeaders;
    ...
    * @throws HttpError
    */
    public async GET(url: string, headers?: object | null): Promise<RestResponse<HttpResponse>>
    {
        const finalOptions: HttpRequestOptions = {
            method: "GET",
            url,
